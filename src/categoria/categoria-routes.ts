...
categoriaRouter.put('/:id', authLogin, validateId, validateCategoria('update'), handleValidation, update)
categoriaRouter.patch('/:id', authLogin, validateId, validateCategoria('update'), handleValidation, update)
