...
administradorRouter.put('/:id', superAuthLogin, validateId, validateAdmin('update'), handleValidation, update)
administradorRouter.patch('/:id', superAuthLogin, validateId, validateAdmin('update'), handleValidation, update)
