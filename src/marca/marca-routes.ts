...
marcaRouter.post('/', authLogin, upload.single('imagen'), createContext, validateMarca('create'), validateImagen, handleValidation, add)
marcaRouter.put('/:id', authLogin, upload.single('imagen'), createContext, validateId, validateMarca('update'), validateImagen, handleValidation, update)
marcaRouter.patch('/:id', authLogin, upload.single('imagen'), createContext, validateId, validateMarca('update'), validateImagen, handleValidation, update)
